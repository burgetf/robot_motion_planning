...
class ROS_server
{
	public:
		...
		//Functions to set Flag activating and deactivating setInitialRobotPose callback
		static bool isSimRosSetInitialRobotPoseData();
		static void resetSimRosSetInitialRobotPoseData();
		
		//Function to get the initial robot pose data
		static const vrep_common::simRosSetRobotPose::Request& getSimRosGetInitialRobotPoseMsg();
...
//		static bool simRosGetObjectQuaternionService(vrep_common::simRosGetObjectQuaternion::Request &req,vrep_common::simRosGetObjectQuaternion::Response &res);
		...
		//-----------------------Testing ----------------------------
		static ros::ServiceServer simRosSetInitialRobotPoseServer;
		static bool simRosSetInitialRobotPoseService(vrep_common::simRosSetRobotPose::Request &req,vrep_common::simRosSetRobotPose::Response &res);
		
		//Flag to activate and deactivate setInitialRobotPose callback
		static bool simRosSetInitialRobotPoseData;
		//
		static vrep_common::simRosSetRobotPose::Request initialRobotPoseMsg;
		//---------------------------------------------------
