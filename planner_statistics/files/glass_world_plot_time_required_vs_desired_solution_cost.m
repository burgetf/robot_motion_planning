...
time_punishment_unreached_cost = 180;
...
ylim([60 time_punishment_unreached_cost+0.5]);
%xlabel('Desired Solution Cost');
%ylabel('Avg. Solution Time [s]');
xlabel('Desired Solution Cost $c_{SP}$','Interpreter','LaTex','FontSize',17)
ylabel('Avg. Solution Time [s]','Interpreter','LaTex','FontSize',17)
title('Desired Final Solution Cost vs. Avg. Solution Time','Interpreter','LaTex','FontSize',17)
%title('Desired Final Solution Cost vs. Avg. Solution Time');
...
ax = gca;
ax.YTickLabel = {'60','80','100','120','140','160','N/A'};
