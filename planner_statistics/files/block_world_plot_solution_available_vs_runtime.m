...
first_solution_available = 120 : -1 : 0;
...
for i = 1:num_planners
    ...
    for j = 0:run_indices
        ...
        if planner_statistics{2}{3} == 1
            ...
            index_smallest_reached_solution_time = find(first_solution_time>=first_solution_available,1);
            ...
            time_solution_available(i,1:index_smallest_reached_solution_time) = time_solution_available(i,1:index_smallest_reached_solution_time) +1;
...
hdl = plot(first_solution_available,time_solution_available_percent(1,:),line_style{1}, ...
           ...
           first_solution_available,time_solution_available_percent(7,:),line_style{7}, ...
           first_solution_available,time_solution_available_percent(8,:),line_style{8}, ...
...
file_path2 = ['../figures/' scene_name '_planning_runtime_vs_solution_available.fig'];
